...
<body>
    ...
    <div id="content1" class="content">
        ...
        <h1>💌Carta💌</h1>
        <p class="letter">Querida Señorita Emilia🌹,</p>
    ...
    <div id="content3" class="content">
        ...
        <div class="acrostic-container">
            ...
            <div class="acrostic">
               <p>E:ncantadora y especial, llena de vida todo lugar</p>
               <p>M:aravillosa y atenta, tiene un brillo único y singular</p>
               <p>I:nteligente en todos los sentidos</p>
               <p>L:uminosa y juiciosa, acelera mis latidos</p>
               <p>I:rradia alegría y ilumina mi vida con su sonrisa</p>
               <p>A:uténtica y única, como una cálida brisa</p>
            </div>
